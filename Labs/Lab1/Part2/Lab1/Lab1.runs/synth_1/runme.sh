...
HD_PWD='C:/Users/drobi/Desktop/fs/Lab1/Part2/Lab1/Lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log majorcontroller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source majorcontroller.tcl
