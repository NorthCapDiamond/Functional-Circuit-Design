...
HD_PWD='C:/Users/drobi/Desktop/fs/Lab1/Part2/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log majorcontroller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source majorcontroller.tcl -notrace
